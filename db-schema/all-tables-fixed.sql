...
-- Set up row level security (RLS) for peptides
ALTER TABLE public.peptides ENABLE ROW LEVEL SECURITY;

-- Create policies for peptides
...
-- Set up row level security (RLS) for inventory_peptides
ALTER TABLE public.inventory_peptides ENABLE ROW LEVEL SECURITY;

-- Create policies for inventory_peptides
...
-- Set up row level security (RLS) for inventory_bac_water
ALTER TABLE public.inventory_bac_water ENABLE ROW LEVEL SECURITY;

-- Create policies for inventory_bac_water
...
-- Set up row level security (RLS) for inventory_syringes
ALTER TABLE public.inventory_syringes ENABLE ROW LEVEL SECURITY;

-- Create policies for inventory_syringes
...
-- Set up row level security (RLS) for inventory_other_items
ALTER TABLE public.inventory_other_items ENABLE ROW LEVEL SECURITY;

-- Create policies for inventory_other_items
...
-- Set up row level security (RLS) for health_metric_logs
ALTER TABLE public.health_metric_logs ENABLE ROW LEVEL SECURITY;

-- Create policies for health_metric_logs
